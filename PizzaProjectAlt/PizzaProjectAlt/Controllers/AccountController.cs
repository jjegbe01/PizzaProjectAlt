...
namespace PizzaProjectAlt.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, ProfilePicture = model.ProfilePicture, Location = model.Location, FavoritePizzaria = model.FavoritePizzaria, PizzaEatingStyle = model.PizzaEatingStyle};
