...
namespace PizzaProjectAlt.Controllers
{
    public class PizzasController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "pizzaID,pizzaName,doughType,sauceType,cheeseType,toppingOne,toppingTwo,toppingThree,toppingFour,toppingFive")] Pizza pizza)
        {
            if (ModelState.IsValid)
            {
